...
public class JFrameCounter extends JFrame {
    ...
    public JFrameCounter() {
        try {
            ...
            Handler orangeHandler = new OrangeHandler(null);
            Handler blueHandler = new BlueHandler(orangeHandler);
            Handler greenHandler = new GreenHandler(blueHandler);
            Handler redHandler = new RedHandler(greenHandler);
            CounterHandler counterHandler = new CounterHandler(redHandler);
            counter.addObserver(counterHandler);
